...
/////////////////////////////////////////////////////////////////////////////////////////
    ...
    public Map<X47BOrgObjectType,Collection<EMail>> getEffectiveEmailsByOrgEntityType() {
    	Map<X47BOrgObjectType,Collection<EMail>> outMap = Maps.newHashMapWithExpectedSize(5);
    	if (_organization != null
    	 && CollectionUtils.hasData(_organization.getEmails())) {
    		outMap.put(X47BOrgObjectType.ORGANIZATION,_organization.getEmails());
    	}
    	
    	if (_orgDivision != null
    	 && CollectionUtils.hasData(_orgDivision.getEmails())) {
    		outMap.put(X47BOrgObjectType.ORG_DIVISION,_orgDivision.getEmails());
    	}
    	
    	if (_orgDivisionService != null
    	 && CollectionUtils.hasData(_orgDivisionService.getEmails())) {
    		outMap.put(X47BOrgObjectType.ORG_DIVISION_SERVICE,_orgDivisionService.getEmails());
    	}
    	
    	if (_orgDivisionServiceLocation != null
    	 && CollectionUtils.hasData(_orgDivisionServiceLocation.getEmails())) {
    		outMap.put(X47BOrgObjectType.ORG_DIVISION_SERVICE_LOCATION,_orgDivisionServiceLocation.getEmails());
    	}    
    	
    	if (_workPlace != null
    	 && CollectionUtils.hasData(_workPlace.getEmails())) {
    		outMap.put(X47BOrgObjectType.WORKPLACE,_workPlace.getEmails());
    	}        	
    	
    	return outMap;
    }
    public Map<X47BOrgObjectType,Collection<Phone>> getEffectivePhonesByOrgEntityType() {
    	Map<X47BOrgObjectType,Collection<Phone>> outMap = Maps.newHashMapWithExpectedSize(5);
    	if (_organization != null
    	 && CollectionUtils.hasData(_organization.getPhones())) {
    		outMap.put(X47BOrgObjectType.ORGANIZATION,_organization.getPhones());
    	}
    	
    	if (_orgDivision != null
    	 && CollectionUtils.hasData(_orgDivision.getPhones())) {
    		outMap.put(X47BOrgObjectType.ORG_DIVISION,_orgDivision.getPhones());
    	}
    	
    	if (_orgDivisionService != null
    	 && CollectionUtils.hasData(_orgDivisionService.getPhones())) {
    		outMap.put(X47BOrgObjectType.ORG_DIVISION_SERVICE,_orgDivisionService.getPhones());
    	}
    	
    	if (_orgDivisionServiceLocation != null
    	 && CollectionUtils.hasData(_orgDivisionServiceLocation.getPhones())) {
    		outMap.put(X47BOrgObjectType.ORG_DIVISION_SERVICE_LOCATION,_orgDivisionServiceLocation.getPhones());
    	}  
    	
    	if (_workPlace != null
    	 && CollectionUtils.hasData(_workPlace.getPhones())) {
    		outMap.put(X47BOrgObjectType.WORKPLACE,_workPlace.getPhones());
    	}      	
