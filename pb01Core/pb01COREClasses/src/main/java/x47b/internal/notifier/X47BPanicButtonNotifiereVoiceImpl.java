...
public class X47BPanicButtonNotifiereVoiceImpl
     extends X47BPanicButtonNotifierBase<NotifierConfigForVoice> {
/////////////////////////////////////////////////////////////////////////////////////////
//  FIELDS
/////////////////////////////////////////////////////////////////////////////////////////
		...
		_voiceNotifier.notifyAll(_config.getFrom(),alarmMessage.getPhonesSanitized(),
								 new Factory<String>() {
										...
										public String create() {
											return _composeVoiceMessage(_velocityEngine,_config.getAppConfigAs(X47BNotifierConfigForVoice.class)
																							   .getMsgTemplatePath(),
