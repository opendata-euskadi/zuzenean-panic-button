...
public class X47BOrgDivisionService
     extends X47BOrganizationalPersistableObjectBase<X47BOrgDivisionServiceOID,X47BOrgDivisionServiceID,
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public ObjectValidationResult<X47BOrgDivisionService> validate() {
		return X47BOrganizationalObjectsValidators.createOrgDivisionServiceValidator()
													   .validate(this);
	}
}
