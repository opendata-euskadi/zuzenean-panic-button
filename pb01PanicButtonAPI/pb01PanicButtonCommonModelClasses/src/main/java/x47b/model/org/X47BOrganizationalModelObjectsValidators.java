...
import x47b.model.X47BEntityObjectsValidators;

@NoArgsConstructor(access=AccessLevel.PRIVATE)
public abstract class X47BOrganizationalModelObjectsValidators {
/////////////////////////////////////////////////////////////////////////////////////////
//	BASE	
/////////////////////////////////////////////////////////////////////////////////////////
	public static <E extends X47BOrganizationalModelObjectBase<?,?,E>> Validates<E> createOrgObjectValidatorBase() {
		return new Validates<E>() {
						@Override @SuppressWarnings("unchecked")
						public ObjectValidationResult<E> validate(final E obj) {
							// super valid?
							ObjectValidationResult<E> superValidResult = X47BEntityObjectsValidators.<E>createEntityObjectValidatorBase()
																							  .validate(obj);
							// this valid?
	...
	public static Validates<X47BOrgDivision> createOrgDivisionValidator() {
		return new Validates<X47BOrgDivision>() {
						...
						public ObjectValidationResult<X47BOrgDivision> validate(final X47BOrgDivision obj) {
							// super valid?
							ObjectValidationResult<X47BOrgDivision> superValidResult = X47BOrganizationalModelObjectsValidators.<X47BOrgDivision>createOrgObjectValidatorBase()
																							  								   .validate(obj);
							// this valid?
	...
	public static Validates<X47BOrgDivisionService> createOrgDivisionServiceValidator() {
		return new Validates<X47BOrgDivisionService>() {
						...
						public ObjectValidationResult<X47BOrgDivisionService> validate(final X47BOrgDivisionService obj) {
							// super valid?
							ObjectValidationResult<X47BOrgDivisionService> superValidResult = X47BOrganizationalModelObjectsValidators.<X47BOrgDivisionService>createOrgObjectValidatorBase()
																							  								   .validate(obj);
							// this valid?
	...
	public static Validates<X47BOrgDivisionServiceLocation> createOrgDivisionServiceLocationValidator() {
		return new Validates<X47BOrgDivisionServiceLocation>() {
						...
						public ObjectValidationResult<X47BOrgDivisionServiceLocation> validate(final X47BOrgDivisionServiceLocation obj) {
							// super valid?
							ObjectValidationResult<X47BOrgDivisionServiceLocation> superValidResult = X47BOrganizationalModelObjectsValidators.<X47BOrgDivisionServiceLocation>createOrgObjectValidatorBase()
																							  								   .validate(obj);
							// this valid?
