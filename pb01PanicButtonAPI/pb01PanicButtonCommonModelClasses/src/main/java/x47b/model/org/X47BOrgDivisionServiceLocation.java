...
public class X47BOrgDivisionServiceLocation
     extends X47BOrganizationalModelObjectBase<X47BOrgDivisionServiceLocationOID,X47BOrgDivisionServiceLocationID,
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public ObjectValidationResult<X47BOrgDivisionServiceLocation> validate() {
		return X47BOrganizationalModelObjectsValidators.createOrgDivisionServiceLocationValidator()
													   .validate(this);
	}
}
