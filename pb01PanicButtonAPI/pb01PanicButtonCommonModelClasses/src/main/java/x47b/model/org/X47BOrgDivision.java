...
public class X47BOrgDivision 
     extends X47BOrganizationalModelObjectBase<X47BOrgDivisionOID,X47BOrgDivisionID,
     								   		   X47BOrgDivision> {
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public ObjectValidationResult<X47BOrgDivision> validate() {
		return X47BOrganizationalModelObjectsValidators.createOrgDivisionValidator()
													   .validate(this);
	}
}
