 ...
 * @param <O>
 */
public interface X47BOrganizationalModelObject<O extends X47BPersistableObjectOID,ID extends X47BModelObjectID<O>> 
		 extends X47BEntityObject<O,ID>,
	 ...
	 * @return
	 */
	public <T extends X47BOrganizationalModelObject<O,ID>> SummarizedModelObject<T> getSummarizedIn(Language lang);
