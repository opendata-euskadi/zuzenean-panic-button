...
public class X47BWorkPlace
     extends X47BOrganizationalModelObjectBase<X47BWorkPlaceOID,X47BWorkPlaceID,X47BWorkPlace> {
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	@Getter @Setter private X47BOrganizationalModelObjectRef<X47BOrgDivisionServiceOID,X47BOrgDivisionServiceID> _orgDivisionServiceRef;
	
	@MarshallField(as="location")
	@Getter @Setter private X47BOrganizationalModelObjectRef<X47BOrgDivisionServiceLocationOID,X47BOrgDivisionServiceLocationID> _orgDivisionServiceLocationRef;
