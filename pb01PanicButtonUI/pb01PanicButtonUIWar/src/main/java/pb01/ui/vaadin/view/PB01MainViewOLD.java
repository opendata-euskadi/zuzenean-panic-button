...
/////////////////////////////////////////////////////////////////////////////////////////
	@Inject
	public PB01MainViewOLD(final UII18NService i18n,
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	private void _showOrganizationDetailViewForCreatingNewRecord() {
		...
		_orgDetailPopUp.forCreating(// save subscriber: executed after save: refresh the combo
						 		    UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrganizationSaved,		// OK subscriber
						 		    						   PB01MainViewOLD.this::_onPersistenceError)); 	// Error subscriber
		UI.getCurrent()
	...
	private void _showOrganizationDetailViewForEditingExistingRecord(final X47BOrgObjectRef<X47BOrganizationOID,X47BOrganizationID> orgRef) {
		...
		_orgDetailPopUp.forEditing(orgRef.getOid(),
						 		   ...
						 		   UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrganizationDeleted,// OK subscriber
						 		    						  PB01MainViewOLD.this::_onPersistenceError));	// Error subscriber
		UI.getCurrent()
		  .addWindow(_orgDetailPopUp);
	}
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	private void _showOrgDivDetailViewForCreatingNewRecord() {
		...
		_orgDivDetailPopUp.forCreating(_cmbSelectedOrgRef,
							 		   ...
							 		   UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivSaved,		// OK subscriber
						 		    						      PB01MainViewOLD.this::_onPersistenceError)); // Error subscriber,
		UI.getCurrent()
	...
	private void _showOrgDivDetailViewForEditingExistingRecord(final X47BOrgObjectRef<X47BOrgDivisionOID,X47BOrgDivisionID> orgDivRef) {
		...
		_orgDivDetailPopUp.forEditing(orgDivRef.getOid(),
							 		  ...
							 		  UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivSaved,			// OK subscriber
						 		    						     PB01MainViewOLD.this::_onPersistenceError), 	// Error subscriber,
							 		  // delete subscriber: executed after delete
							 		  UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivDeleted,		// OK subscriber
						 		    						     PB01MainViewOLD.this::_onPersistenceError)); 	// Error subscriber,
		UI.getCurrent()
		  .addWindow(_orgDivDetailPopUp);
	}
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	private void _showOrgDivSrvcDetailViewForCreatingNewRecord() {
		...
		_orgDivSrvcDetailPopUp.forCreating(_cmbSelectedOrgRef,_cmbSelectedOrgDivRef,
							 		   	   // save subscriber: executed after save: refresh the combo
							 		   	   UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivSrvcSaved,		// OK subscriber
						 		    						          PB01MainViewOLD.this::_onPersistenceError)); 	// Error subscriber
		UI.getCurrent()
	...
	private void _showOrgDivSrvcDetailViewForEditingExistingRecord(final X47BOrgObjectRef<X47BOrgDivisionServiceOID,X47BOrgDivisionServiceID> orgDivSrvcRef) {
		...
		_orgDivSrvcDetailPopUp.forEditing(orgDivSrvcRef.getOid(),
								 		  ...
								 		  UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivSrvcSaved,		// OK subscriber
							 		    						     PB01MainViewOLD.this::_onPersistenceError),// Error subscriber,
								 		  // delete subscriber: executed after delete
								 		  UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivSrvcDeleted,	// OK subscriber
						 		    						         PB01MainViewOLD.this::_onPersistenceError)); 	// Error subscriber
		UI.getCurrent()
		  .addWindow(_orgDivSrvcDetailPopUp);
	}
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	private void _showOrgDivSrvcLocDetailViewForCreatingNewRecord() {
		...
		_orgDivSrvcLocDetailPopUp.forCreating(_cmbSelectedOrgRef,_cmbSelectedOrgDivRef,_cmbSelectedOrgDivSrvcRef,
								 		   	  // save subscriber: executed after save: refresh the combo
								 		   	  UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivSrvcLocSaved,		// OK subscriber
							 		    						         PB01MainViewOLD.this::_onPersistenceError));		// Error subscriber
		UI.getCurrent()
	...
	private void _showOrgDivSrvcLocDetailViewForEditingExistingRecord(final X47BOrgObjectRef<X47BOrgDivisionServiceLocationOID,X47BOrgDivisionServiceLocationID> orgDivSrvcLocRef) {
		...
		_orgDivSrvcLocDetailPopUp.forEditing(orgDivSrvcLocRef.getOid(),
								 		  	 ...
								 		  	 UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivSrvcLocSaved,		// OK subscriber
							 		    						        PB01MainViewOLD.this::_onPersistenceError),		// Error subscriber,
								 		  	 // delete subscriber: executed after delete
								 		  	 UIPresenterSubscriber.from(PB01MainViewOLD.this::_onOrgDivSrvcLocDeleted,		// OK subscriber
							 		    						        PB01MainViewOLD.this::_onPersistenceError));		// Error subscriber
		UI.getCurrent()
		  .addWindow(_orgDivSrvcLocDetailPopUp);
	}
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	private void _showWorkPlaceDetailViewForCreatingNewRecord() {
		...
		_workPlaceDetailPopUp.forCreating(_cmbSelectedOrgRef,_cmbSelectedOrgDivRef,_cmbSelectedOrgDivSrvcRef,_cmbSelectedOrgDivSrvcLocRef,
								 		  // save subscriber: executed after save: refresh the combo
								 		  UIPresenterSubscriber.from(PB01MainViewOLD.this::_onWorkPlaceSaved,		// OK subscriber
							 		    						     PB01MainViewOLD.this::_onPersistenceError));	// Error subscriber
		UI.getCurrent()
	...
	private void _showWorkPlaceDetailViewForEditingExistingRecord(final X47BOrgObjectRef<X47BWorkPlaceOID,X47BWorkPlaceID> workPlaceRef) {
		...
		_workPlaceDetailPopUp.forEditing(workPlaceRef.getOid(),
								 		 ...
								 		 UIPresenterSubscriber.from(PB01MainViewOLD.this::_onWorkPlaceSaved,		// OK subscriber
							 		    						    PB01MainViewOLD.this::_onPersistenceError),	// Error subscriber,
								 		 // delete subscriber: executed after delete
								 		 UIPresenterSubscriber.from(PB01MainViewOLD.this::_onWorkPlaceDeleted,		// OK subscriber
							 		    						    PB01MainViewOLD.this::_onPersistenceError));	// Error subscriber
		UI.getCurrent()
		  .addWindow(_workPlaceDetailPopUp);
	}
