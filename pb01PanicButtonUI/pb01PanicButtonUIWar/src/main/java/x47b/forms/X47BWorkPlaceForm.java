...
/**
 * Componente formulario para la edición de lugares de trabajo
 */
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public X47BWorkPlace getWorkPlace() {		
		...
		_workPlace.setName(LanguageTextsBuilder.createMapBacked()
	...
	public void setValue(final X47BWorkPlaceOID workPlaceOID) {		
		...
		_nameES.setValue(_workPlace.getName().getFor(Language.SPANISH));
		_nameEU.setValue(_workPlace.getName().getFor(Language.BASQUE));
