...
/**
 * Componente formulario para la edici�n de  localizaciones
 */
@Accessors(prefix="_")
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public X47BLocationForm(GridLayout fLayout, X47BAPIHelper api) {
		...
		// Al cambiar de organizacion se recarga el combo de Localizaciones
...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public X47BOrgDivisionServiceLocation getLocation() {
		...
		_location.setNameByLanguage(LanguageTextsBuilder.createMapBacked()
	...
	public void setValue(X47BOrgDivisionServiceLocationOID locationOID) {
		...
		_nameES.setValue(_location.getName().getIn(Language.SPANISH).orNull());
		_nameEU.setValue(_location.getName().getIn(Language.BASQUE).orNull());
