...
/**
 * Componente formulario para la edición de  organizaciones
 */
public class X47BOrganizationForm extends X47BEntityObjectForm<X47BOrganization> {	
	...
	public X47BOrganization getOrganization() {		
		...
		_organization.setName(LanguageTextsBuilder.createMapBacked()
	...
	public void setValue(X47BOrganization org) {			
		...
		_nameES.setValue(_organization.getName().getFor(Language.SPANISH));
		_nameEU.setValue(_organization.getName().getFor(Language.BASQUE));
