...
/////////////////////////////////////////////////////////////////////////////////////////
	/**
	 * Devuelve de OID del puesto de trabajo o de la localización
	 * @return
	 */
	public X47BPersistableObjectOIDBase getEntityOid() {
		if (_searchResult != null) {
			if (_searchResult.getModelObjectType() == X47BWorkPlace.class) {
				return _searchResult.getWorkPlace().getOid();
			} else if (_searchResult.getModelObjectType() == X47BOrgDivisionServiceLocation.class) {
