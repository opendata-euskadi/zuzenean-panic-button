...
public class PB01TPersistableModelObjectFindTest<O extends PersistableObjectOID,M extends PersistableModelObject<O>> {
/////////////////////////////////////////////////////////////////////////////////////////
//  
/////////////////////////////////////////////////////////////////////////////////////////
...
//  
/////////////////////////////////////////////////////////////////////////////////////////
	public static <O extends PersistableObjectOID,M extends PersistableModelObject<O>> PB01TPersistableModelObjectFindTest<O,M> create(final ClientAPIDelegateForModelObjectFindServices<O,M> findAPI) {
		return new PB01TPersistableModelObjectFindTest<O,M>(findAPI);
	}
/////////////////////////////////////////////////////////////////////////////////////////
//  
/////////////////////////////////////////////////////////////////////////////////////////
