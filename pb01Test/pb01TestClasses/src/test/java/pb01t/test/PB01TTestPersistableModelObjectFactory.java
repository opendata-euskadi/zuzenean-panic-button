...
public class PB01TTestPersistableModelObjectFactory<O extends PersistableObjectOID,M extends PersistableModelObject<O>> {
/////////////////////////////////////////////////////////////////////////////////////////
//  
/////////////////////////////////////////////////////////////////////////////////////////
...
//  
/////////////////////////////////////////////////////////////////////////////////////////
	public static <O extends PersistableObjectOID,M extends PersistableModelObject<O>> PB01TTestPersistableModelObjectFactory<O,M> create(final ClientAPIDelegateForModelObjectCRUDServices<O,M> crudAPI) {
		return new PB01TTestPersistableModelObjectFactory<O,M>(crudAPI);
	}
/////////////////////////////////////////////////////////////////////////////////////////
//  
/////////////////////////////////////////////////////////////////////////////////////////
