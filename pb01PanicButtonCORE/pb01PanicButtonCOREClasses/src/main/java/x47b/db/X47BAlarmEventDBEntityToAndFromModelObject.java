...
/////////////////////////////////////////////////////////////////////////////////////////
	...
	public X47BAlarmEvent dbEntityToModelObject(final SecurityContext securityContext,
		...
		outAlarm.setDivision(new X47BOrgObjectRef<X47BOrgDivisionOID,X47BOrgDivisionID>(X47BOrgDivisionOID.forId(dbAlarm.getDivisionOid()),
																									    X47BOrgDivisionID.forId(dbAlarm.getDivisionId())));
		outAlarm.setService(new X47BOrgObjectRef<X47BOrgDivisionServiceOID,X47BOrgDivisionServiceID>(X47BOrgDivisionServiceOID.forId(dbAlarm.getServiceOid()),
																									    			 X47BOrgDivisionServiceID.forId(dbAlarm.getServiceId())));
		outAlarm.setLocation(new X47BOrgObjectRef<X47BOrgDivisionServiceLocationOID,X47BOrgDivisionServiceLocationID>(X47BOrgDivisionServiceLocationOID.forId(dbAlarm.getLocationOid()),
