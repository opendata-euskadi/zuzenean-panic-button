...
/////////////////////////////////////////////////////////////////////////////////////////
	private X47BWorkPlace _buildMockWorkPlace() {
		...
		outWorkPlace.setId(X47BWorkPlaceID.forId(Strings.customized("{}/{}",
															_location.getId(),
															randomWorkPlace)));
		outWorkPlace.setOrgRef(new X47BOrgObjectRef<X47BOrganizationOID,X47BOrganizationID>(_organization.getOid(),_organization.getId()));
		outWorkPlace.setOrgDivisionRef(new X47BOrgObjectRef<X47BOrgDivisionOID,X47BOrgDivisionID>(_division.getOid(),_division.getId()));
		outWorkPlace.setOrgDivisionServiceRef(new X47BOrgObjectRef<X47BOrgDivisionServiceOID,X47BOrgDivisionServiceID>(_service.getOid(),_service.getId()));
		outWorkPlace.setOrgDivisionServiceLocationRef(new X47BOrgObjectRef<X47BOrgDivisionServiceLocationOID,X47BOrgDivisionServiceLocationID>(_location.getOid(),_location.getId()));
